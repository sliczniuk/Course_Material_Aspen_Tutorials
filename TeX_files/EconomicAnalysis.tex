...
%		\centering
%		\vspace{-15pt}
%		\includegraphics[trim = 2cm 2cm 0cm 1cm,clip, width=0.34\textwidth]{Figures/Econmic_Analysis/Equipment_selection.jpg}
%		\vspace{-10pt}
